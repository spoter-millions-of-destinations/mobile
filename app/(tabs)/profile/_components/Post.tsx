    ...
    return (
        <View className=" flex-row mb-[13] w-full flex-1">
            ...
            <View className="flex-1 w-full gap-y-1">
                ...
                <View className="mb-[5] w-fit flex-1 ">
                    <Text className="text-black text-[10px] font-light font-['Montserrat'] w-10/12">{description}</Text>
                </View>
                <View>
