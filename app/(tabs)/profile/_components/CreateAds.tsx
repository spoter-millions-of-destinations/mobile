        ...
        <TouchableOpacity onPress={handlePayment} className="ml-5">
            <View className="flex-row items-center justify-between">
                <View className="flex-row items-center gap-x-3">
                    <Wallet2 />
                    <View>
                        <Text className="text-neutral-600 text-sm font-semibold font-['Montserrat']">Stripe</Text>
    ...
    return (
        <View className="flex-col items-center">
            {data.map((item) => (
                ...
                >
                    <Image className="w-[305px] h-[213px] rounded-[15px] " source={item.image} />
                </TouchableOpacity>
            ))}
        </View>
    )
        ...
        <SafeAreaView className="flex-1 bg-neutral-50">
            <ScrollView className="px-6 ">
                ...
                <AccordionItem
                    ...
                    content={<PostItem info={info} handleChangeInfo={handleChangeInfo} />}
                />
                <AccordionItem
                    border={true}
                ...
                <View className="flex-row items-center justify-between">
                    ...
                    <TouchableOpacity className="px-[15px] py-[5px] bg-neutral-200 rounded-[10px] justify-between items-center">
                        <Text className="text-neutral-500 text-xs font-normal font-['Montserrat']">Spread</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </SafeAreaView>
