import { BackRightToLeft, Building, Clock, Coffee, Hotel, Info, Mark, Microphone } from '@/assets/images/Button'
    ...
    return (
        <SafeAreaView className="flex-1 bg-neutral-50 ">
            <View className="px-6">
                ...
                <FlatList data={_searchHistory} renderItem={({ item }) => <RecenlyResult data={item} />} />
            </View>
        </SafeAreaView>
    )
}
...
const ItemSave = ({ data }) => {
    ...
    return (
        <View className="flex-row items-center mr-[25]">
            <View className="w-10 h-10 bg-sky-100 rounded-full mr-[10] items-center justify-center">{icon}</View>
            <View>
                <Text class="text-neutral-800 text-sm font-medium font-['Montserrat']">{title}</Text>
        ...
        <View className="mb-[15]">
            <View className="flex-row items-center mb-[15]">
                ...
                <View className="ml-5">
                    ...
                    <Text className="text-neutral-500 text-xs font-normal font-['Montserrat'] ">{position}</Text>
                </View>
            </View>
